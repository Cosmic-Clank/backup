...
def main(log_filepath):
    ...
    data = logfile_data_extractor.extract_data("ganache-20231103-134515.log")
    ...
    print(risk_level_result)
#risk_level_result, risk_assessment.print_state()

main("ganache-20231103-134515.log")